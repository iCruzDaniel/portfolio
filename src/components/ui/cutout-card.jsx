...
// ============================================================================
// Tokens — border + shadow stack using theme tokens so elevation reads in both modes
// ============================================================================
...
/** JIT `img` adaptation — original uses next/image `fill`; we use object-cover absolute instead. */
export function CutoutCardImage({ className, alt = '', fill = true, ...props }) {
  return (
    <img
      alt={alt}
      className={cn(
...
/** Corner badge shell (e.g. top-right “New”); add corners as siblings inside. */
